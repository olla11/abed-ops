...
export function HonorairesSection() {
  ...
  return (
    <div className="card" style={{ marginBottom: 16 }}>
      ...
      <p style={{ fontSize: 12, color: 'var(--abed-muted)', margin: '0 0 14px' }}>
        F CFA / heure, utilisé au calcul du montant à la validation CAF d'un timesheet.
      </p>
...
export function PaliersSection() {
...
export function SalairesSection() {
  ...
  return (
    <div className="card" style={{ marginBottom: 16 }}>
      ...
      <p style={{ fontSize: 12, color: 'var(--abed-muted)', margin: '0 0 14px' }}>
        Salaire brut mensuel et primes diverses par grade et échelon. Utilisé à la création d'un contrat CDI/CDD.
      </p>
      <div style={{ overflowX: 'auto' }}>
...
export function AllocationsSection() {
  ...
  return (
    <div className="card">
      ...
      <p style={{ fontSize: 12, color: 'var(--abed-muted)', margin: '0 0 14px' }}>
        Allocation mensuelle de communication/internet. Référence de calcul (pas encore de circuit de paiement dédié pour les bénévoles).
      </p>
      <div style={{ overflowX: 'auto' }}>
