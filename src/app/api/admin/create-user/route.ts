...
// POST /api/admin/create-user — Réservé admin / rh / caf.
export async function POST(req: NextRequest) {
  ...
  const { email, password, nom, prenoms, telephone, fonction,
    ifu, grade_indice, adresse, date_naissance, lieu_naissance, nationalite } = body
