  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto;">
      ...
      <div style="background: #f9fafb; padding: 24px 28px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        ...
        <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
          <tr><td style="font-weight:600; width:150px; padding:6px 0; vertical-align:top;">Objectifs</td><td>${escapeHtml(rapport?.objectifs ?? '—')}</td></tr>
          ...
          <tr><td style="font-weight:600; padding:6px 0; vertical-align:top;">Suite</td><td>${escapeHtml(rapport?.suite ?? '—')}</td></tr>
        </table>
