...
export async function GET(
  ...
  const pdfData: EvaluationPdfData = {
    ...
    appreciationEvaluation: ev.appreciation_evaluation ?? null,
    noteAbed: ev.note_abed ?? null,
    perspectiveContinuation: ev.perspective_continuation ?? null,
    conditionsContinuation: ev.conditions_continuation ?? null,
