...
const TABS = [
  { href: '/caf', label: 'Tableau de bord', exact: true },
  { href: '/caf/demandes-paiement', label: 'Demandes de paiement' },
  { href: '/caf/rapports-allocations', label: "Rapports d'allocation" },
  { href: '/caf/reconciliations', label: 'Réconciliations OM' },
  { href: '/caf/timesheets', label: 'Timesheets & paiements' },
]
