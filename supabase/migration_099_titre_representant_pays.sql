-- Migration 099 : ajoute le titre/poste "Représentant Pays".
...
ALTER TYPE titre_poste ADD VALUE IF NOT EXISTS 'representant_pays';

CREATE OR REPLACE FUNCTION public.attribuer_titre(cible uuid, nouveau_titre titre_poste, nouveau_type type_emploi DEFAULT NULL::type_emploi)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
