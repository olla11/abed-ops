-- attribuer_titre() doit connaître 'responsable_hub' (ajouté en migration_120)
-- pour lui donner l'accès 'manager' lors de l'attribution — sinon le CASE
-- retombe sur son ELSE ('missionnaire'), bien en-deçà de ce qui est voulu.
...
BEGIN
  ...
  access := CASE titre_final
    ...
    WHEN 'responsable_hub'           THEN 'manager'
